...
class Student:
	def __init__(self, root):
		...
		#First image section======	
		img=Image.open(r"F:\machine\img\student.jpg")
    ...
    #background image=======
		...
		title_lbl=Label(bg_img,text="STUDENT MANAGEMENT SYSTEM",font=("Sketchy In Snow", 35,"bold"),bg="red",fg="white")
		...
		img_left=Image.open(r"F:\machine\img\stdnt.jpg")
		...
		dep_combo["values"]=("Select Department","Computer Science And Engineering","Aeronautical Engineering","Mechatronics Engineering","Electrical And Electronics Engineering")
		dep_combo.current(0)
		...
		save_btn=Button(btn_frame,text="Save", command=self.add_data,width=19,font=("times new roman",12,"bold"),bg="red",fg="white")
		save_btn.grid(row=0,column=0)

		update_btn=Button(btn_frame,text="Update", command=self.update_data,width=19,font=("times new roman",12,"bold"),bg="red",fg="white")
		update_btn.grid(row=0,column=1)

		delete_btn=Button(btn_frame,text="Delete",command=self. delete_data,width=19,font=("times new roman",12,"bold"),bg="red",fg="white")
		delete_btn.grid(row=0,column=2)

		reset_btn=Button(btn_frame,text="Reset", command=self.reset_data,width=19,font=("times new roman",12,"bold"),bg="red",fg="white")
		...
		take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take Photo Sample",width=40,font=("times new roman",12,"bold"),bg="red",fg="white")
		take_photo_btn.grid(row=0,column=0)

		update_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Update Photo Sample",width=40,font=("times new roman",12,"bold"),bg="red",fg="white")
		update_photo_btn.grid(row=0,column=1)

		#right frame label
		Right_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
		Right_frame.place(x=700,y=0,width=660,height=580)

		#image section
		img_right=Image.open(r"F:\machine\img\group cls 02.jpg")
		...
		search_btn=Button(search_frame,text="Search",width=12,command=self.search_data,font=("times new roman",12,"bold"),bg="red",fg="white")
		search_btn.grid(row=0,column=3,padx=4)

		showAll=Button(search_frame,text="Show All",command=self.fetch_data,width=12,font=("times new roman",12,"bold"),bg="red",fg="white")
	...
	def update_data(self):
		if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
			...
			try:
				speak_va('Do you wanna update this Student Details.')
				...
				if Update > 0:
					...
					if not Update:
						return
				speak_va('Student details successfully updated.')
	...
	def delete_data(self):
		if self.var_std_id.get()=="":
			speak_va('Student Id must be required!')
			messagebox.showerror("Error","Student Id must be required!", parent=self.root)
		else:
			try:
				speak_va('Do you wanna delete this Student?')
				...
				self.fetch_data()			
				conn.close()	
				speak_va('Successfully deleted student details')	
