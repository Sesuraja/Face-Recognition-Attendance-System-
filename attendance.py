...
class Attendance:
	...
	#First image section======	
		img=Image.open(r"F:\machine\img\group.jpg")
    ...
    #second image section======
		...
		title_lbl=Label(bg_img,text="ATTENDANCE MANAGEMENT SYSTEM",font=("Sketchy In Snow", 35,"bold"),bg="red",fg="white")
		...
		img_left=Image.open(r"F:\machine\img\group cls 02.jpg")
		...
		save_btn=Button(btn_frame,text="Import csv",width=19,command=self.importCsv,font=("times new roman",12,"bold"),bg="red",fg="white")
		save_btn.grid(row=0,column=0)

		update_btn=Button(btn_frame,text="Export csv",width=19,command=self.exportCsv,font=("times new roman",12,"bold"),bg="red",fg="white")
		update_btn.grid(row=0,column=1)

		delete_btn=Button(btn_frame,text="Update",width=19,font=("times new roman",12,"bold"),bg="red",fg="white")
	...
	def exportCsv(self):
		try:
			if len(mydata)<1:
				speak_va('No Data found to export')
			...
			with open(fln,mode="w",newline="") as myfile:
				...
				for i in mydata:
					...
					speak_va('Your data exported successfully')
