...
class Login_window(object):
	...
	def __init__(self, root):
		...
		#Image
		self.bg=ImageTk.PhotoImage(file=r"F:\machine\img\LoginImg.jpg")
		...
		img1=Image.open(r"F:\machine\img\loginIcon.png")
		...
		#=======Icon Images=====
		img2=Image.open(r"F:\machine\img\customerUser.png")
		...
		#======Password Icon=====
		img3=Image.open(r"F:\machine\img\passwordIc.png")
	...
	def login(self):
		if self.txtuser.get()=="" or self.txtpass.get()=="":
			...
			if row==None:
				speak_va('Invalid Username & Password')
				messagebox.showerror("Error", "Invalid Username & Password")
			else:
				speak_va('Access only Admin')
				open_main=messagebox.askyesno("YesNo", "Access only Admin")
				
				if open_main > 0:
					self.new_window=Toplevel(self.root)
					self.app=Face_Recognition_System(self.new_window)
					speak_va('Welcome to Face Recognition Attendance System!')
	...
	def forgot_password_window(self):
		if self.txtuser.get()=="":
			...
			#Opening new window if correct email
				...
				#reset button
				btn=Button(self.root2,text="Reset",command=self.reset_pass,font=("times new roman",15,"bold"),fg="white",bg="red")
...
class Register:
	def __init__(self, root):
		...
		#=======Bg Image====
		self.bg=ImageTk.PhotoImage(file=r"F:\machine\img\background.jpg")

		lbl_bg=Label(self.root,image=self.bg)
		lbl_bg.place(x=0,y=0,relwidth=1,relheight=1) 

		#====left image=====
		self.bg1=ImageTk.PhotoImage(file=r"F:\machine\img\regLeft.jpg")
		...
		#=============Buttons============
		img=Image.open(r"F:\machine\img\RegR.jpg")
		...
		#Login Button
		img1=Image.open(r"F:\machine\img\loginR.png")
...
class Face_Recognition_System:
	...
	#First image section======	
		img=Image.open(r"F:\machine\img\varsity.jpg")
    ...
    #second image section======
		img1=Image.open(r"F:\machine\img\facialrecognition.png")
    ...
    #3rd image section=======
		img2=Image.open(r"F:\machine\img\clg.jpg")
    ...
    #background image=======
		img3=Image.open(r"F:\machine\img\background.jpg")
	...
	#Title bar above background image======	
		title_lbl=Label(bg_img,text="FACE RECOGNITION ATTENDANCE SYSTEM",font=("Sketchy In Snow", 35,"bold"),bg="white",fg="blue")
	...
	#student button====
		img4=Image.open(r"F:\machine\img\student.jpg")
		
		img4=img4.resize((195,195),Image.ANTIALIAS)
		self.photoimg4=ImageTk.PhotoImage(img4)

		b1=Button(bg_img,image=self.photoimg4, command=self.student_details,cursor="hand2")
		b1.place(x=100,y=80,width=195,height=195)
		...
		b1_1.place(x=100,y=245,width=195,height=40)

	#face detection button====
		img5=Image.open(r"F:\machine\img\face_detector1.jpg")
		
		img5=img5.resize((195,195),Image.ANTIALIAS)
		self.photoimg5=ImageTk.PhotoImage(img5)

		b1=Button(bg_img,image=self.photoimg5,cursor="hand2", command=self.face_data)
		b1.place(x=400,y=80,width=195, height=195)
		...
		b1_1.place(x=400,y=245,width=195,height=40)

	#Attendance detection button====
		img6=Image.open(r"F:\machine\img\smart-attendance.jpg")
		
		img6=img6.resize((195,195),Image.ANTIALIAS)
		self.photoimg6=ImageTk.PhotoImage(img6)

		b1=Button(bg_img,image=self.photoimg6,cursor="hand2",command=self.attendance_data)
		b1.place(x=700,y=80,width=195, height=195)
		...
		b1_1.place(x=700,y=245,width=195,height=40)

	#Help desk button====
		img7=Image.open(r"F:\machine\img\help.jpg")
		
		img7=img7.resize((195,195),Image.ANTIALIAS)
		self.photoimg7=ImageTk.PhotoImage(img7)

		b1=Button(bg_img,image=self.photoimg7,cursor="hand2", command=self.help_data)
		b1.place(x=1000,y=80,width=195, height=195)

		b1_1=Button(bg_img,text="Help Desk ",cursor="hand2",command=self.help_data,font=("Sketchy In Snow", 15,"bold"),bg="darkblue",fg="white")
		b1_1.place(x=1000,y=245,width=195,height=40)

	#Train button====
		img8=Image.open(r"F:\machine\img\train_data.jpg")
		
		img8=img8.resize((195,195),Image.ANTIALIAS)
		self.photoimg8=ImageTk.PhotoImage(img8)

		b1=Button(bg_img,image=self.photoimg8,cursor="hand2", command=self.train_data)
		b1.place(x=100,y=350,width=195, height=195)
		...
		b1_1.place(x=100,y=525,width=195,height=40)

	#Photos button====
		img9=Image.open(r"F:\machine\img\photo.jpg")
		
		img9=img9.resize((195,195),Image.ANTIALIAS)
		self.photoimg9=ImageTk.PhotoImage(img9)

		b1=Button(bg_img,image=self.photoimg9,cursor="hand2", command=self.open_img)
		b1.place(x=400,y=350,width=195, height=195)

		b1_1=Button(bg_img,text="Photos",cursor="hand2", command=self.open_img, font=("Sketchy In Snow", 15,"bold"),bg="darkblue",fg="white")
		b1_1.place(x=400,y=525,width=195,height=40)

	#Developer button====
		img10=Image.open(r"F:\machine\img\dev.jpg")
		
		img10=img10.resize((195,195),Image.ANTIALIAS)
		self.photoimg10=ImageTk.PhotoImage(img10)

		b1=Button(bg_img,image=self.photoimg10,cursor="hand2",command=self.developer_data)
		b1.place(x=700,y=350,width=195, height=195)
